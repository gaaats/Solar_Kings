...
import com.fuzzyhouse.wonderwoollie.data.Constances.APPS_KEY
import com.fuzzyhouse.wonderwoollie.data.Constances.MAIN_CHECKER
import com.fuzzyhouse.wonderwoollie.data.Constances.MY_TRACKER_KEY
import com.fuzzyhouse.wonderwoollie.data.Constances.ONE_SIIIIIGN
import com.fuzzyhouse.wonderwoollie.data.Constances.key_instId
import com.fuzzyhouse.wonderwoollie.data.Constances.keyCodeFromHost
import com.fuzzyhouse.wonderwoollie.data.Constances.keyDEEPLINK
import com.fuzzyhouse.wonderwoollie.data.Constances.keyLinkaa
import com.fuzzyhouse.wonderwoollie.data.Constances.keyMAIN_ID
import com.fuzzyhouse.wonderwoollie.data.Constances.keyMainForSharedPref
import com.fuzzyhouse.wonderwoollie.data.Constances.keyNaming
import com.fuzzyhouse.wonderwoollie.data.Constances.key_my_first_time
        ...
        AppLinkData.fetchDeferredAppLinkData(
            ...
            appLinkData?.let {
                appLinkData.targetUri?.host.toString().apply {
                    ...
                    Log.d("lolo", "getDeep deep is ${this}")
                }
