package com.fuzzyhouse.wonderwoollie.uttiils
...
class BeamModel(application: Application): ViewModel() {
    val pmhyhyhyhy = application.packageManager
    ...
    fun appInstalledOrNot(uri: String): Boolean {
        try {
            pmhyhyhyhy.getPackageInfo("org.telegram.messenger", PackageManager.GET_ACTIVITIES)
            return true
