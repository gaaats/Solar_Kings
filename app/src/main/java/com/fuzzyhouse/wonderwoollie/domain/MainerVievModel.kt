...
import com.fuzzyhouse.wonderwoollie.data.DataHolder.advertId
import com.fuzzyhouse.wonderwoollie.data.DataHolder.buildVers
import com.fuzzyhouse.wonderwoollie.data.DataHolder.instId
import com.fuzzyhouse.wonderwoollie.data.DataHolder.linka
import com.fuzzyhouse.wonderwoollie.domain.usercases.*
                    ...
                    while (true) {
                        if (DataHolder.tempDeepLoad != null) {
                            ...
                            if (makeDepplinCheckUseCase.makeDepplinCheckUseCase()) {
                                //link deeplinka
                                Log.d("lolo", "in 0 makeDepplinCheckUseCase")
                                ...
                                if (makeGeoCheckUseCase.makeGeoCheckUseCase()) {
                                    Log.d("lolo", "in 0 makeGeoCheckUseCase.makeGeoCheckUseCase()")
                                    // link geo or fb
                                    ...
                                    Log.d("lolo", "in 0 ellllse go to game")
                                    goToGame()
                                    break
                                }
                            }
